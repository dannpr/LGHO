...
contract GhoModule {
    address immutable GHO_ADDRESS =
        address(0xc4bF5CbDaBE595361438F8c6a187bDc330539c60); // Set the GHO token address
    address immutable USDC_ADDRESS =
        address(0x13fA158A117b93C27c55b8216806294a0aE88b6D); // Set the USDC token address
    address immutable GHO_AAVE_POOL_ADDRESS =
        address(0x6Ae43d3271ff6888e7Fc43Fd7321a503ff738951); // Set the Aave V3 lending pool address
